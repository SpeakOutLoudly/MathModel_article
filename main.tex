...
\include{contents/model_assumption}
\include{contents/theory_base}
\include{contents/model_solution}
%\include{contents/result_analysis}
%\include{contents/model_assessment}
