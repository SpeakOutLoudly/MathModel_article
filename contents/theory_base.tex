...
\section[\hspace{-2pt}CIE1931标准色度观察者与光谱三刺激值]{{\heiti\zihao{4} \hspace{-8pt}CIE1931标准色度观察者与光谱三刺激值}}\label{section2: CIE1931标准色度观察者与光谱三刺激值}
...
\section[\hspace{-2pt}CIEXYZ颜色空间]{{\heiti\zihao{4} \hspace{-8pt}CIEXYZ颜色空间}}\label{section2: CIEXYZ颜色空间}
...
\section[\hspace{-2pt}CIELab颜色空间]{{\heiti\zihao{4} \hspace{-8pt}CIELab颜色空间}}\label{section2: CIELab颜色空间}
...
\section[\hspace{-2pt}CIE1931xy色度图与色域表示]{{\heiti\zihao{4} \hspace{-8pt}CIE1931xy色度图与色域表示}}\label{section2: CIE1931xy色度图与色域表示}
...
\section[\hspace{-2pt}CIEDE2000色差公式]{{\heiti\zihao{4} \hspace{-8pt}CIEDE2000色差公式}}\label{section2: CIEDE2000色差公式}
...
\section[\hspace{-2pt}颜色感知与颜色空间]{{\heiti\zihao{4} \hspace{-8pt}颜色感知与颜色空间}}\label{section2: 颜色感知与颜色空间}
...
\section[\hspace{-2pt}色域与色域映射]{{\heiti\zihao{4} \hspace{-8pt}色域与色域映射}}\label{section2: 色域与色域映射}
...
\section[\hspace{-2pt}颜色差异度量 ($\Delta E$)]{{\heiti\zihao{4} \hspace{-8pt}颜色差异度量 ($\Delta E$)}}\label{section2: 颜色差异度量}
...
\textbf{前向变换（编码）：}
\begin{equation}
I_{\text{encoded}} = \text{clip}((I_{\text{linear}} \cdot S)^{\gamma}, [0,1])
\end{equation}

\textbf{反向变换（线性化）：}
\begin{equation}
I_{\text{linear}} = \text{clip}((I_{\text{encoded}})^{1/\gamma} / S, [0,1])
\end{equation}

其中$\text{clip}(\cdot, [0,1])$函数确保输出值在有效范围内。

\subsection[\hspace{-2pt}伽马校正的物理意义]{{\heiti\zihao{-4} \hspace{-8pt}伽马校正的物理意义}}\label{subsection2: 伽马校正的物理意义}
